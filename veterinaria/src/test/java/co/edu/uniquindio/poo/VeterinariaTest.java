...
public class VeterinariaTest {
    ...
    public void TestDatosCompletosVeterinaria() {
        ...
        Mascota mascota = new Mascota("Maximiliano", "Canino", "Frespuder", (byte)7, "Masculino", "Dorado", 12.5 );
   ...
   public void TestDatosNegativosVeterinaria(){
    ...
    assertThrows(Throwable.class, ()-> new Mascota("Maximiliano", "Canino", "Frespuder", (byte)-7, "Masculino", "Dorado", -12.5 ));
